...
public class PPExpansionHubs implements ISubsystem {
    private PPAutoRobot robot;
    ...
    public PPExpansionHubs(PPAutoRobot robot, ExpansionHubEx masterHub, ExpansionHubEx slaveHub) {
        setRobot(robot);
    ...
    public PPAutoRobot getRobot() {
        return robot;
    }

    public void setRobot(PPAutoRobot arobot) {
        this.robot = arobot;
    }
